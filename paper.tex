...
\end{align}
with ${}^ZA$ representing a nucleus of mass number $A$ and charge $Z$.
...
Explicit definitions are given in App.~\ref{sec:def_momentum}.
...
\footnote{TODO: state num independent components}
...
\footnote{TODO: compute $L$, put in figure}
