...
(Eqns.~\ref{eqn:num_x}--\ref{eqn:num_tau}) in the following configurations,
and compare $f$ or moments of $f$ to known analytic solutions, or in some
cases to fiducial numerical calculations.
