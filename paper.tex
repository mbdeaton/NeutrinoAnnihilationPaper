...
\end{equation}
where our symbol $\langle \tilde{\varepsilon} \rangle(\cos A)$ expresses
...
we also examine $\langle \tilde{\varepsilon} \rangle(\cos A)$
...
for $\nu_e$ and $\bar{\nu}_e$. In contrast $\langle \tilde{\varepsilon} \rangle$
