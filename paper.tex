...
simulated volume (i.e.\ inside $r\sim70$~km) and asymptoting to the $r^{-3}$
density field of a spherical steady-state wind.
\footnote{TODO: confirm whether this is accurate}
The rest density from this model is plotted in Fig.~\ref{fig:test_traj_density}.
\footnote{TODO: cite Surman \& McLaughlin ApJ 618, 2005}
