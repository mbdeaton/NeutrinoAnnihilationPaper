...
$\omega' \equiv 1-\ell'_\alpha \ell^\alpha$.
...
\begin{equation}
  ...
  R(\varepsilon,\omega) \approx R_0(\varepsilon) + \omega R_1(\varepsilon),
\end{equation}
which allows us to write Eqns.~\ref{eqn:se_factor} and \ref{eqn:se_opacity} as
\begin{align}
  \label{eqn:se_factor_expansion}
  \Phi_{{\rm SE},i} &=  \frac{(2\pi)^3}{\varepsilon^3}\frac{1}{4\pi}
  J(\varepsilon) -
  \frac{1}{\mathscr{K}_{{\rm SE},i}} \ell^\alpha H_\alpha(\varepsilon)\\
  \label{eqn:se_opacity_expansion}
  \mathscr{K}_{{\rm SE},i} &= 4\pi \frac{\varepsilon^3}{(2\pi)^3}
  \big(R_0(\varepsilon)+R_1(\varepsilon)\big).
\end{align}
