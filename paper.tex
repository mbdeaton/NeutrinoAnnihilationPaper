...
evolution coordinates. We extrapolate the fluid and M1 radiation data from
this grid to the larger ray tracing grid by setting all variables to their
floor values. This simple extrapolation is adequate for ray tracing since
